...
export class RegisterFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = this.fb.group({
      id: [{ value: '', disabled: this.editMode }, [Validators.required, Validators.minLength(3), Validators.maxLength(10), this.noSpecialCharsValidator]],
      name: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(10), this.noSpecialCharsValidator]],
      description: ['', [Validators.required, Validators.minLength(5), Validators.maxLength(100), this.noSpecialCharsValidator]],
